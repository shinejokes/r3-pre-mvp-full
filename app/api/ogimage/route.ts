...
function svgTemplate(params: { title: string; views: number; ref: string }) {
...
<svg width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    .title { font-family: sans-serif; font-size: 56px; font-weight: 700; fill: #0f172a; }
    .views { font-family: sans-serif; font-size: 40px; font-weight: 600; fill: #1e293b; }
    .ref   { font-family: sans-serif; font-size: 34px; fill: #334155; }
    .brand { font-family: sans-serif; font-size: 30px; fill: #475569; }
  </style>
...
export async function GET(req: NextRequest) {
  try {
    ...
    const svg = svgTemplate({ title, views: viewCount, ref });
